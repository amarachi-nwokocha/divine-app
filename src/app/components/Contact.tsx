      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-2xl shadow-xl max-w-4xl w-full p-8 relative grid md:grid-cols-2 gap-6"
          >
            {/* Close Button */}
            <button
            ...
            {!submitted ? (
              ...
              >
                ...
                <input
                  ...
                  required
                  className="w-full border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-[#189086]"
                />
                ...
                <div className="flex gap-2">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-2/3 border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-[#189086]"
                  />
                </div>
